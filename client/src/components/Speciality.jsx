...
const Speciality = () => {
  return (
    <div className='flex flex-col items-center justify-center mt-20 gap-6' id='speciality'>
      ...
      <p className='w-88 text-center text-gray-500 text-sm'>Simply browse through our extensive list of trusted doctors, <br/> schedule your appointment hassle-free.</p>
